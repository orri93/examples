...
# Add the parent dircetory to the path so we can import the agents module
...
st.title(":robot: OpenAI Agents Streaming Demo")
st.write("See the streaming capabilities of OpenAI Agents in action!")
...
with st.sidebar:
  ...
  demo_prompt = st.selectbox("Quick Prompt", demo_options)
