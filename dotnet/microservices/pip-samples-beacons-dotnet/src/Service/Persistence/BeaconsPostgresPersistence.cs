...
{
  public class BeaconsPostgresPersistence : IdentifiablePostgresPersistence<BeaconV1, string>, IBeaconsPersistence
  {
    public BeaconsPostgresPersistence() : base("beacons")
    {
