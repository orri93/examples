...
SET GOS_EXAMPLES_MAVEN_BOOT=%GOS_EXAMPLES_MAVEN%\solution\src\maven-solution-project-boot


ECHO Entering %GOS_EXAMPLES_MAVEN_BOOT%
PUSHD "%GOS_EXAMPLES_MAVEN_BOOT%"
"%GOS_EXAMPLES_MVN_CMD%" spring-boot:run -Dspring.profiles.active=dev
POPD
