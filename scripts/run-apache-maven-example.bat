...
SET GOS_EXAMPLES_MAVEN_CAMEL=%GOS_EXAMPLES_MAVEN%\solution\src\maven-solution-project-camel


ECHO Entering %GOS_EXAMPLES_MAVEN_CAMEL%
PUSHD "%GOS_EXAMPLES_MAVEN_CAMEL%"
"%GOS_EXAMPLES_MVN_CMD%" compile exec:java
POPD
