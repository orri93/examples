...
ECHO Entering %GOS_EXAMPLES_MAVEN%
PUSHD "%GOS_EXAMPLES_MAVEN%"
REM "%GOS_EXAMPLES_MVN_CMD%" clean
REM "%GOS_EXAMPLES_MVN_CMD%" clean package install
"%GOS_EXAMPLES_MVN_CMD%" package install
POPD
